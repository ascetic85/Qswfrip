...
public:
    ...
    UI32 GetUI32()				;
    SI32 GetSI32()				;
    UI32 PutUI8(UI8 ubValue)	;
    UI32 PutSI8(SI8 sbValue)	;
    UI32 PutUI16(UI16 usValue)  ;
    UI32 PutSI16(SI16 ssValue)  ;
    UI32 PutUI32(UI32 ulValue)  ;
    UI32 PutSI32(SI32 slValue)  ;
    ...
    UI32 WriteToFile(FILE *pfileFile) ;
